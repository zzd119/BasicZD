...
class GuangZhou_Dataset():
    ...
    def add_datasets_specific_arguments(parent_parser):
        ...
        parser.add_argument("--data_file_path", type=str,
                            default="datasets/{0}/raw_data/{0}.mat".format(dataset_name), help="Raw traffic readings.")
        parser.add_argument("--steps_per_day", type=int,default=144, help="Sequence Length.")
