...
def generate_adj_pems04():
    distance_df_filename, num_of_vertices = "./raw_data/PEMS04/PEMS04.csv", 307
    ...
    with open("./raw_data/adj_PEMS04.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("./raw_data/PEMS04/adj_PEMS04_distance.pkl", "wb") as f:
