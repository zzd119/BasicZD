...
class MTGNN_PEMS07():
    ...
    def add_options_specific_arguments(parent_parser):
        ...
        _, adj_mx = load_adj("datasets/PEMS07/output/adj/adj_mx.pkl","doubletransition")
        adj_mx = torch.tensor(adj_mx) - torch.eye(883)
        temp_args, _ = parent_parser.parse_known_args()
        ...
        parser.add_argument("--num_node", default=883)
