...
class GTS_METRLA():
    ...
    def add_options_specific_arguments(parent_parser):
        ...
        node_feats_full = load_pkl("datasets/METRLA/output/in{0}_out{1}/data_in{0}_out{1}.pkl".format(temp_args.history_seq_len,temp_args.future_seq_len))["processed_data"][..., 0]
        train_index_list = load_pkl("datasets/METRLA/output/in{0}_out{1}/index_in{0}_out{1}.pkl".format(temp_args.history_seq_len,temp_args.future_seq_len))["train"]
        ...
        parser.add_argument("--dim_fc", default=383664)
