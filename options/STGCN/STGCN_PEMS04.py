...
class STGCN_PEMS04():
    ...
    def add_options_specific_arguments(parent_parser):
        ...
        adj_mx,_ = load_adj("datasets/PEMS04/output/in{0}_out{1}/adj_mx.pkl".format(temp_args.history_seq_len,temp_args.future_seq_len), "normlap")
        ...
        parser.add_argument("--n_vertex", default=307)
